//! Tabs with a disabled tab: it is skipped by traversal and ignores clicks.
//!
//! Everything else matches the manual-activation demo — arrow keys move the
//! tab cursor; Enter, Space, or a click commits.
