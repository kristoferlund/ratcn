...
<div class="ratcn-preview-notice">
  ...
  <span>Preview release: the API will break, the CLI stays deliberately small, and more components are coming — text input and text area. Want something specific? Open an issue.</span>
