...
<div class="ratcn-preview-notice">
  ...
  <span>Preview release: the API is unstable. Twelve components are available, with a CLI for terminal project setup and copying component source. Want something specific? Open an issue.</span>
...
<main class="ratcn-home">
  <section class="ratcn-hero" aria-labelledby="ratcn-title">
    ...
    <p class="ratcn-lede">
      ...
      Start a terminal project with the recommended cargo-ratcn CLI.
    </p>
